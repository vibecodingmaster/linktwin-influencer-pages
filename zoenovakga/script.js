/* ============================================================
   ...
   Components:
     ...
     06_hover_to_reveal    → location tag (Athens, GA → live EST time)
   Plus: sparks, age gate, deeplink detection
   ============================================================ */
...
const CONFIG = {
  handle:        'zoenovakga',
  displayHandle: '@ZOENOVAKGA',
  location:      'Athens, GA',
  timezone:      'America/New_York',
  timezoneLabel: 'EST',
  telegramUrl:   'https://go.gramflow.link/zoenovakga',
  bioLines: [
    'sweating, smiling & slaying every day.',
    'southern belle with a warrior spirit.',
    'athens, georgia. fitness & pure fun.',
    'come find me. dms always open.',
    'your favorite georgia peach.',
  ],
};
/* ─────────────────────────────────────────────────────────── */
...
(function initSparks() {
  ...
  for (let i = 0; i < COUNT; i++) {
    ...
    const spin  = (150 + Math.random() * 400).toFixed(0) + 'deg';
