/* ============================================================
   ...
   Plus: ember particles, age gate, deeplink detection
   ============================================================ */
...
const CONFIG = {
  handle:        'yana.ukrainska.goddess',
  displayHandle: '@YANA.UKRAINSKA.GODDESS',
  location:      'Kyiv, Ukraine',
  timezone:      'Europe/Kiev',
  timezoneLabel: 'EET',
  telegramUrl:   'https://go.gramflow.link/yana.ukrainska.goddess',
  bioLines: [
    'daughter of the steppes. untameable.',
    'soft as wheat fields. sharp as winter frost.',
    'where the Dnipro runs, I dream.',
    'blessed by the sun. kissed by storm.',
    'a goddess wrapped in golden silk.',
  ],
};
/* ─────────────────────────────────────────────────────────── */
...
/* ──────────────────────────────────────────────────────────────
   5. LOCATION TAG — hover to reveal live EET time
   ────────────────────────────────────────────────────────────── */
